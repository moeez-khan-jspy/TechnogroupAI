!function(t, e, n, o) {
    ...
    if (n)
        if (n.fn.fancybox)
            ...
            , h = function() {
                ...
                n.fancybox.isMobile && (this.opts = n.extend(!0, {}, this.opts, this.opts.mobile)),
                ...
                this.firstRun = null,
                this.createGroup(t),
                this.group.length && (this.$lastFocus = n(e.activeElement).blur(),
                this.slides = {},
                this.init())
            };
            n.extend(u.prototype, {
                init: function() {
                    var o, i, s, a = this, c = a.group[a.currIndex], l = c.opts, h = n.fancybox.scrollbarWidth;
                    a.scrollTop = r.scrollTop(),
                    a.scrollLeft = r.scrollLeft(),
                    n.fancybox.getInstance() || (n("body").addClass("fancybox-active"),
                    /iPad|iPhone|iPod/.test(navigator.userAgent) && !t.MSStream ? "image" !== c.type && n("body").css("top", -1 * n("body").scrollTop()).addClass("fancybox-iosfix") : !n.fancybox.isMobile && e.body.scrollHeight > t.innerHeight && (void 0 === h && (o = n('<div style="width:50px;height:50px;overflow:scroll;" />').appendTo("body"),
                    h = n.fancybox.scrollbarWidth = o[0].offsetWidth - o[0].clientWidth,
                    o.remove()),
                    n("head").append('<style id="fancybox-style-noscroll" type="text/css">.compensate-for-scrollbar { margin-right: ' + h + "px; }</style>"),
                    n("body").addClass("compensate-for-scrollbar"))),
                    s = "",
                    n.each(l.buttons, function(t, e) {
                        s += l.btnTpl[e] || ""
                    }),
                    i = n(a.translate(a, l.baseTpl.replace("{{buttons}}", s).replace("{{arrows}}", l.btnTpl.arrowLeft + l.btnTpl.arrowRight))).attr("id", "fancybox-container-" + a.id).addClass("fancybox-is-hidden").addClass(l.baseClass).data("FancyBox", a).appendTo(l.parentEl),
                    a.$refs = {
                        container: i
                    },
                ...
                createGroup: function(t) {
                    ...
                    n.each(o, function(t, o) {
                        ...
                        h = o.opts || o) : "object" === n.type(o) && n(o).length ? (h = (i = n(o)).data(),
                        ...
                        r = l.src || "",
                        !s && r && (r.match(/(^data:image\/[a-z0-9+\/=]*,)|(\.(jp(e|g|eg)|gif|png|bmp|webp|svg|ico)((\?|#).*)?$)/i) ? s = "image" : r.match(/\.(pdf)((\?|#).*)?$/i) ? s = "pdf" : (a = r.match(/\.(mp4|mov|ogv)((\?|#).*)?$/i)) ? (s = "video",
                        l.opts.videoFormat || (l.opts.videoFormat = "video/" + ("ogv" === a[1] ? "ogg" : a[1]))) : "#" === r.charAt(0) && (s = "inline")),
                        ...
                        "function" === n.type(l.opts.caption) && (l.opts.caption = l.opts.caption.apply(o, [e, l])),
                        "function" === n.type(e.opts.caption) && (l.opts.caption = e.opts.caption.apply(o, [e, l])),
                        l.opts.caption instanceof n || (l.opts.caption = void 0 === l.opts.caption ? "" : l.opts.caption + ""),
                        "ajax" === s && (c = r.split(/\s+/, 2)).length > 1 && (l.src = c.shift(),
                ...
                jumpTo: function(t, e, o) {
                    var i, s, a, r, c, l, h, u = this, f = u.group.length;
                    if (!(u.isDragging || u.isClosing || u.isAnimating && u.firstRun)) {
                        if (t = parseInt(t, 10),
                        !(s = u.current ? u.current.opts.loop : u.opts.loop) && (t < 0 || t >= f))
                            return !1;
                        if (i = u.firstRun = null === u.firstRun,
                        !(f < 2 && !i && u.isDragging)) {
                            if (r = u.current,
                            u.prevIndex = u.currIndex,
                            u.prevPos = u.currPos,
                            a = u.createSlide(t),
                            f > 1 && ((s || a.index > 0) && u.createSlide(t - 1),
                            ...
                            n.each(u.slides, function(t, o) {
                                ...
                                n.fancybox.animate(o.$slide, {
                                    ...
                                    o.pos === u.currPos && (a.isMoved = !1,
                                    u.complete())
                                })
                            })) : u.$refs.stage.children().removeAttr("style"),
                            a.isLoaded ? u.revealContent(a) : u.loadSlide(a),
                            u.preload("image"),
                            r.pos !== a.pos && (h = "fancybox-slide--" + (r.pos > a.pos ? "next" : "previous"),
                            r.$slide.removeClass("fancybox-slide--complete fancybox-slide--current fancybox-slide--next fancybox-slide--previous"),
                            r.isComplete = !1,
                            e && (a.isMoved || a.opts.transitionEffect) && (a.isMoved ? r.$slide.addClass(h) : (h = "fancybox-animated " + h + " fancybox-fx-" + a.opts.transitionEffect,
                ...
                scaleToActual: function(t, e, o) {
                    var i, s, a, r, c, l = this, h = l.current, d = h.$content, u = parseInt(h.$slide.width(), 10), f = parseInt(h.$slide.height(), 10), p = h.width, g = h.height;
                    "image" != h.type || h.hasError || !d || l.isAnimating || (n.fancybox.stop(d),
                    l.isAnimating = !0,
                    t = void 0 === t ? .5 * u : t,
                    e = void 0 === e ? .5 * f : e,
                ...
                scaleToFit: function(t) {
                    ...
                    "image" != i.type || i.hasError || !s || o.isAnimating || (n.fancybox.stop(s),
                    o.isAnimating = !0,
                    e = o.getFitPos(i),
                ...
                getFitPos: function(t) {
                    var e, o, i, s, a, r = t.$content, c = t.width, l = t.height, h = t.opts.margin;
                    return !(!r || !r.length || !c && !l) && ("number" === n.type(h) && (h = [h, h]),
                ...
                updateSlide: function(t, e) {
                    var o = t && t.$content;
                    o && (t.width || t.height) && (this.isAnimating = !1,
                    n.fancybox.stop(o),
                ...
                updateCursor: function(t, e) {
                    ...
                    (void 0 !== t && void 0 !== e ? t < this.current.width && e < this.current.height : this.isScaledDown()) ? n.addClass("fancybox-can-zoomIn") : this.current.opts.touch ? n.addClass("fancybox-can-drag") : n.addClass("fancybox-can-zoomOut")) : this.current.opts.touch && n.addClass("fancybox-can-drag"))
                },
                isZoomable: function() {
                    var t, e = this.current;
                    if (e && !this.isClosing)
                        return !!("image" === e.type && e.isLoaded && !e.hasError && ("zoom" === e.opts.clickContent || n.isFunction(e.opts.clickContent) && "zoom" === e.opts.clickContent(e)) && (t = this.getFitPos(e),
                ...
                loadSlide: function(t) {
                    ...
                    if (!t.isLoading && !t.isLoaded) {
                        ...
                        e = t.type,
                        (o = t.$slide).off("refresh").trigger("onReset").addClass("fancybox-slide--" + (e || "unknown")).addClass(t.opts.slideClass),
                        e) {
                        case "image":
                            s.setImage(t);
                            break;
                ...
                setImage: function(e) {
                    var o, i, s, a, r = this, c = e.opts.srcset || e.opts.image.srcset;
                    if (c) {
                ...
                setIframe: function(t) {
                    ...
                    s.on("refresh.fb", function() {
                        var n, o, s = t.$content, a = i.css.width, r = i.css.height;
                        if (1 === e[0].isReady) {
                            try {
                                o = e.contents().find("body")
                            } catch (t) {}
                            o && o.length && (void 0 === a && (n = e[0].contentWindow.document.documentElement.scrollWidth,
                            a = Math.ceil(o.outerWidth(!0) + (s.width() - n)),
                            a += s.outerWidth() - s.innerWidth()),
                            void 0 === r && (r = Math.ceil(o.outerHeight(!0)),
                ...
                setContent: function(t, e) {
                    ...
                    t.$slide.empty(),
                    (o = e) && o.hasOwnProperty && o instanceof n && e.parent().length ? (e.parent(".fancybox-slide--inline").trigger("onReset"),
                ...
                afterLoad: function(t) {
                    ...
                    this.hideLoading(t),
                    t.opts.smallBtn && !t.$smallBtn && (t.$smallBtn = n(this.translate(t, t.opts.btnTpl.smallBtn)).appendTo(t.$content.filter("div,form").first())),
                ...
                revealContent: function(t) {
                    var e, o, i, s, a, r = this, c = t.$slide, l = !1;
                    ...
                    "zoom" === e ? ((a = r.getFitPos(t)).scaleX = a.width / l.width,
                    ...
                    d(c),
                    void n.fancybox.animate(c, "fancybox-slide--current", i, function(e) {
                ...
                getThumbPos: function(o) {
                    var i, s = !1, a = o.opts.$thumb, r = a ? a.offset() : 0;
                    return r && a[0].ownerDocument === e && function(e) {
                        for (var o = e[0], i = o.getBoundingClientRect(), s = []; null !== o.parentElement; )
                ...
                close: function(t, e) {
                    var o, i, s, a, r, c, u = this, f = u.current, p = function() {
                        u.cleanUp(t)
                    };
                    ...
                    f.$slide.off(h).removeClass("fancybox-slide--complete fancybox-slide--next fancybox-slide--previous fancybox-animated"),
                    f.$slide.siblings().trigger("onReset").remove(),
                    i && u.$refs.container.removeClass("fancybox-is-open").addClass("fancybox-is-closing"),
                    u.hideLoading(f),
                    u.hideControls(),
                    u.updateCursor(),
                    "zoom" !== o || !0 !== t && s && i && "image" === f.type && !f.hasError && (c = u.getThumbPos(f)) || (o = "fade"),
                    ...
                    !0) : (o && i ? !0 === t ? setTimeout(p, i) : n.fancybox.animate(f.$slide.removeClass("fancybox-slide--current"), "fancybox-animated fancybox-slide--previous fancybox-fx-" + o, i, p) : p(),
                    !0)))
                },
                cleanUp: function(t) {
                    var o, i, s = n("body");
                    ...
                    this.current = null,
                    (o = n.fancybox.getInstance()) ? o.activate() : (a.scrollTop(this.scrollTop).scrollLeft(this.scrollLeft),
                    s.removeClass("fancybox-active compensate-for-scrollbar"),
                    s.hasClass("fancybox-iosfix") && (i = parseInt(e.body.style.top, 10),
                    s.removeClass("fancybox-iosfix").css("top", "").scrollTop(-1 * i)),
                ...
                updateControls: function(t) {
                    ...
                    i.find("[data-fancybox-next]").prop("disabled", !e.opts.loop && n >= this.group.length - 1),
                    "image" === e.type ? i.find("[data-fancybox-download]").attr("href", e.opts.image.src || e.src).show() : i.find("[data-fancybox-download],[data-fancybox-zoom]").hide()
                },
            ...
            n.fancybox = {
                ...
                getInstance: function(t) {
                    ...
                    return e instanceof u && ("string" === n.type(t) ? e[t].apply(e, o) : "function" === n.type(t) && t.apply(e, o),
                    e)
                },
                open: function(t, e, n) {
                    return new u(t,e,n)
                ...
                t.getComputedStyle && t.getComputedStyle(i).getPropertyValue("transform") && !(e.documentMode && e.documentMode < 11)),
                ...
                animate: function(t, e, o, i, s) {
                    ...
                    t.on(h, function(o) {
                        ...
                        !1 === s && t.removeAttr("style")) : !0 !== s && t.removeClass(e),
                        n.isFunction(i) && i(o))
                    }),
    ...
    function f(t) {
        ...
        i ? (s = (a = (a = o.selector ? n(o.selector) : t.data ? t.data.items : []).length ? a.filter('[data-fancybox="' + i + '"]') : n('[data-fancybox="' + i + '"]')).index(e)) < 0 && (s = 0) : a = [e],
    ...
    t(document).on("objectNeedsType.fb", function(o, i, s) {
        ...
        t.each(a, function(n, o) {
            if (c = u.match(o.matcher)) {
                ...
                return l = t.extend(!0, {}, o.params, s.opts[n], d),
                u = "function" === t.type(o.url) ? o.url.call(this, c, l, s) : e(o.url, c, l),
                r = "function" === t.type(o.thumb) ? o.thumb.call(this, c, l, s) : e(o.thumb, c),
        ...
        s.opts.slideClass += " fancybox-slide--video")) : u && (s.type = s.opts.defaultType)
    })
...
function(t, e, n) {
    ...
    l.prototype.ontouchstart = function(o) {
        ...
        (!o.originalEvent || 2 != o.originalEvent.button) && i.length && !r(i) && !r(i.parent()) && (i.is("img") || !(o.originalEvent.clientX > i[0].clientWidth + i.offset().left))) {
            if (!h || this.instance.isAnimating || this.instance.isClosing)
                return o.stopPropagation(),
                void o.preventDefault();
            this.realPoints = this.startPoints = s(o),
            this.startPoints && (o.stopPropagation(),
            this.startEvent = o,
            this.canTap = !0,
            this.$target = i,
            this.$content = d,
            ...
            (this.opts || l.canPan()) && (i.is(this.$stage) || this.$stage.find(i).length) ? (n.fancybox.isMobile && (c(i) || c(i.parent())) || o.preventDefault(),
            1 === this.startPoints.length && ("image" === h.type && (this.contentStartPos.width > this.canvasWidth + 1 || this.contentStartPos.height > this.canvasHeight + 1) ? (n.fancybox.stop(this.$content),
            ...
            2 !== this.startPoints.length || l.isAnimating || h.hasError || "image" !== h.type || !h.isLoaded && !h.$ghost || (this.canTap = !1,
            this.isSwiping = !1,
            this.isPanning = !1,
            this.isZooming = !0,
            ...
            this.startDistanceBetweenFingers = a(this.startPoints[0], this.startPoints[1]))) : i.is("img") && o.preventDefault())
        }
    }
    ,
    ...
    l.prototype.ontouchmove = function(t) {
        var e = n(t.target);
        this.isScrolling || !e.is(this.$stage) && !this.$stage.find(e).length ? this.canTap = !1 : (this.newPoints = s(t),
        (this.opts || this.instance.canPan()) && this.newPoints && this.newPoints.length && (this.isSwiping && !0 === this.isSwiping || t.preventDefault(),
    ...
    l.prototype.limitMovement = function() {
        ...
        f > a && (c > 0 && i > t && (i = t - 1 + Math.pow(-t + d + c, .8) || 0),
        c < 0 && i < n && (i = n + 1 - Math.pow(n - d - c, .8) || 0)),
        p > r && (l > 0 && s > e && (s = e - 1 + Math.pow(-e + u + l, .8) || 0),
    ...
    l.prototype.ontouchend = function(t) {
        ...
        this.canTap)
            return this.onTap(t);
        this.speed = 366,
        this.velocityX = this.distanceX / o * .5,
        this.velocityY = this.distanceY / o * .5,
    ...
    l.prototype.endSwiping = function(t, e) {
        ...
        o = this.instance.close(!0, 300)) : "x" == t && this.distanceX > 50 && i > 1 ? o = this.instance.previous(this.speedX) : "x" == t && this.distanceX < -50 && i > 1 && (o = this.instance.next(this.speedX)),
        !1 !== o || "x" != t && "y" != t || (e || i < 2 ? this.instance.centerSlide(this.instance.current, 150) : this.instance.jumpTo(this.instance.current.index)),
    ...
    l.prototype.onTap = function(t) {
        var e, o = this, i = n(t.target), a = o.instance, r = a.current, c = t && s(t) || o.startPoints, l = c[0] ? c[0].x - o.$stage.offset().left : 0, h = c[0] ? c[0].y - o.$stage.offset().top : 0, d = function(e) {
            var i = r.opts[e];
            if (n.isFunction(i) && (i = i.apply(a, [r, t])),
            i)
                switch (i) {
                case "close":
        ...
        if ((!t.originalEvent || 2 != t.originalEvent.button) && (i.is("img") || !(l > i[0].clientWidth + i.offset().left))) {
            if (i.is(".fancybox-bg,.fancybox-inner,.fancybox-outer,.fancybox-container"))
                ...
                if (!a.current.$content || !a.current.$content.find(i).addBack().filter(i).length)
                    return;
                e = "Content"
            }
            if (o.tapped) {
...
function(t, e) {
    ...
    e.extend(n.prototype, {
        ...
        create: function() {
            var t, n, o = this.instance, i = this.opts.parentEl;
            this.$grid = e('<div class="fancybox-thumbs fancybox-thumbs-' + this.opts.axis + '"></div>').appendTo(o.$refs.container.find(i).addBack().filter(i)),
            t = "<ul>",
            ...
            this.$list.find("img").hide().one("load", function() {
                var t, n, o, i, s = e(this).parent().removeClass("fancybox-thumbs-loading"), a = s.outerWidth(), r = s.outerHeight();
...
function(t, e) {
    ...
    e(t).on("click", "[data-fancybox-share]", function() {
        ...
        s && (t = !1 === s.current.opts.hash ? s.current.src : window.location,
        n = s.current.opts.share.tpl.replace(/\{\{media\}\}/g, "image" === s.current.type ? encodeURIComponent(s.current.src) : "").replace(/\{\{url\}\}/g, encodeURIComponent(t)).replace(/\{\{url_raw\}\}/g, (o = t,
        i = {
            "&": "&amp;",
            "<": "&lt;",
            ">": "&gt;",
    ...
    n(function() {
        !1 !== n.fancybox.defaults.hash && (n(t).on({
            "onInit.fb": function(t, e) {
                ...
                (o = c(e)) && n.gallery && o == n.gallery && (e.currIndex = n.index - 1))
            },
            "beforeShow.fb": function(n, a, r) {
                var l;
                r && !1 !== r.opts.hash && (l = c(a)) && "" !== l && (e.location.hash.indexOf(l) < 0 && (a.opts.origHash = e.location.hash),
                i = l + (a.group.length > 1 ? "-" + (r.index + 1) : ""),
                "replaceState"in e.history ? (s && clearTimeout(s),
                s = setTimeout(function() {
                    e.history[o ? "pushState" : "replaceState"]({}, t.title, e.location.pathname + e.location.search + "#" + i),
                    s = null,
                    o = !1
        ...
        n(e).on("hashchange.fb", function() {
            var t = a();
            n.fancybox.getInstance() ? !i || i === t.gallery + "-" + t.index || 1 === t.index && i == t.gallery || (i = null,
            n.fancybox.close()) : "" !== t.gallery && r(t)
        }),
        setTimeout(function() {
            r(a())
        }, 50))
