!function(t, e) {
    ...
    t.MixItUp.prototype = {
        ...
        _init: function(e, i) {
            if (this._execAction("_init", 0, arguments),
            i && t.extend(!0, this, i),
            this._$body = t("body"),
            this._domNode = e,
            ...
            this._refresh(!0),
            this._$parent = this._$targets.parent().length ? this._$targets.parent() : this._$container,
            this.load.sort && (this._newSort = this._parseSort(this.load.sort),
            this._newSortString = this.load.sort,
            this._activeSort = this.load.sort,
            this._sort(),
            this._printSort()),
            this._activeFilter = "all" === this.load.filter ? this.selectors.target : "none" === this.load.filter ? "" : this.load.filter,
            ...
            this.controls.toggleFilterButtons) {
                ...
                for (var s = 0; s < this._toggleArray.length; s++)
                    this._updateControls({
                        filter: this._toggleArray[s],
                        sort: this._activeSort
                    }, !0)
            } else
                this.controls.enable && this._updateControls({
        ...
        _platformDetect: function() {
            ...
            this._ff = !!a && parseInt(window.navigator.userAgent.match(/rv:([^)]+)\)/)[1]),
            ...
            this._domNode.nextElementSibling === e && Object.defineProperty(Element.prototype, "nextElementSibling", {
                get: function() {
        ...
        _refresh: function(t, i) {
            ...
            if (this._$targets.length && t || !this._origOrder.length && this._$targets.length) {
                this._origOrder = [];
        ...
        _bindHandlers: function() {
            ...
            s[i.selectors.filter] = s[i.selectors.filter] === e ? 1 : s[i.selectors.filter] + 1,
            a[i.selectors.sort] = a[i.selectors.sort] === e ? 1 : a[i.selectors.sort] + 1,
        ...
        _processClick: function(i, s) {
            var a = this
              , n = function(i, s, n) {
                ...
                r._handled["_" + s][a.selectors[s]] = r._handled["_" + s][a.selectors[s]] === e ? 1 : r._handled["_" + s][a.selectors[s]] + 1,
                r._handled["_" + s][a.selectors[s]] === r._bound["_" + s][a.selectors[s]] && (i[(n ? "remove" : "add") + "Class"](a.controls.activeClass),
                delete r._handled["_" + s][a.selectors[s]])
            };
            if (a._execAction("_processClick", 0, arguments),
            !a._mixing || a.animation.queue && a._queue.length < a.animation.queueLimit) {
                if (a._clicking = !0,
                "sort" === s) {
                    var r = i.attr("data-sort");
                    (!i.hasClass(a.controls.activeClass) || r.indexOf("random") > -1) && (t(a.selectors.sort).removeClass(a.controls.activeClass),
                    n(i, s),
                    a.sort(r))
                }
                if ("filter" === s) {
                    var o, l = i.attr("data-filter"), c = "or" === a.controls.toggleLogic ? "," : "";
                    a.controls.toggleFilterButtons ? (a._buildToggleArray(),
                    i.hasClass(a.controls.activeClass) ? (n(i, s, !0),
                    o = a._toggleArray.indexOf(l),
                    a._toggleArray.splice(o, 1)) : (n(i, s),
                    a._toggleArray.push(l)),
                    a._toggleArray = t.grep(a._toggleArray, function(t) {
                        return t
                    }),
                    a._toggleString = a._toggleArray.join(c),
                    a.filter(a._toggleString)) : i.hasClass(a.controls.activeClass) || (t(a.selectors.filter).removeClass(a.controls.activeClass),
                    n(i, s),
                    a.filter(l))
                }
                a._execAction("_processClick", 1, arguments)
            } else
                "function" == typeof a.callbacks.onMixBusy && a.callbacks.onMixBusy.call(a._domNode, a._state, a),
                a._execAction("_processClickBusy", 1, arguments)
        },
        _buildToggleArray: function() {
            var t = this._activeFilter.replace(/\s/g, "");
            if (this._execAction("_buildToggleArray", 0, arguments),
        ...
        _updateControls: function(i, s) {
            var a = this
              ...
              , r = function(t, e) {
                try {
                    s && "filter" === o && "none" !== n.filter && "" !== n.filter ? t.filter(e).addClass(a.controls.activeClass) : t.removeClass(a.controls.activeClass).filter(e).addClass(a.controls.activeClass)
                } catch (t) {}
            }
              , o = "filter"
              , l = null;
            ...
            for (var c = 0; c < 2; c++)
                (l = a.controls.live ? t(a.selectors[o]) : a["_$" + o + "Buttons"]) && r(l, "[data-" + o + '="' + n[o] + '"]'),
                o = "sort";
        ...
        _filter: function() {
            ...
            for (var e = 0; e < this._$targets.length; e++) {
                ...
                i.is(this._activeFilter) ? this._$show = this._$show.add(i) : this._$hide = this._$hide.add(i)
            }
        ...
        _compare: function(t, e, i) {
            ...
            return r < o ? "asc" === a ? -1 : 1 : r > o ? "asc" === a ? 1 : -1 : r === o && s._newSort.length > i + 1 ? s._compare(t, e, i + 1) : 0
        },
        _printSort: function(t) {
            ...
            for (var n = 0; n < i.length; n++) {
                var r = i[n]
                  , o = r.nextSibling;
                "absolute" !== r.style.position && (o && "#text" === o.nodeName && this._$parent[0].removeChild(o),
                this._$parent[0].removeChild(r))
            }
            for (n = 0; n < e.length; n++) {
                var l = e[n];
                if ("default" !== this._newSort[0].sortBy || "desc" !== this._newSort[0].order || t)
                    a.appendChild(l),
            ...
            s ? this._$parent[0].insertBefore(a, s) : this._$parent[0].appendChild(a),
            this._execAction("_printSort", 1, arguments)
        },
        _parseSort: function(t) {
            for (var e = "string" == typeof t ? t.split(" ") : [t], i = [], s = 0; s < e.length; s++) {
                ...
                if (i.push(n),
                "default" === n.sortBy || "random" === n.sortBy)
                    break
            }
        ...
        _parseEffects: function() {
            var t = this
              ...
              , a = function(t, a) {
                for (var n = [["scale", ".01"], ["translateX", "20px"], ["translateY", "20px"], ["translateZ", "20px"], ["rotateX", "90deg"], ["rotateY", "90deg"], ["rotateZ", "180deg"]], r = 0; r < n.length; r++) {
                    var o = n[r][0]
                      , l = n[r][1]
                      , c = a && "scale" !== o;
            ...
            a("transformIn"),
            t.animation.reverseOut ? a("transformOut", !0) : e.transformOut = e.transformIn,
            e.transition = {},
        ...
        _buildState: function(t) {
            var e;
            if (this._execAction("_buildState", 0),
            e = {
                activeFilter: "" === this._activeFilter ? "none" : this._activeFilter,
                activeSort: t && this._newSortString ? this._newSortString : this._activeSort,
                ...
                display: t && this._newDisplay ? this._newDisplay : this.layout.display
            },
            t)
                return this._execFilter("_buildState", e);
            this._state = e,
            this._execAction("_buildState", 1)
        },
        _goMix: function(t) {
            var e = this
              , i = function() {
              ...
              , s = function() {
                ...
                e._prepTargets(),
                window.requestAnimationFrame ? requestAnimationFrame(a) : setTimeout(function() {
                    a()
                }, 20)
            }
              , a = function() {
            ...
            "function" == typeof e.callbacks.onMixStart && e.callbacks.onMixStart.call(e._domNode, e._state, r, e),
        ...
        _getTargetData: function(t, e) {
            ...
            this.animation.animateResizeTargets && (i = this._suckMode ? {
                marginBottom: "",
                marginRight: ""
        ...
        _setInter: function() {
            ...
            this._changingLayout && this.animation.animateChangeLayout ? (this._$toShow.css("display", this._newDisplay),
        ...
        _prepTargets: function() {
            ...
            for (var i = 0; i < this._$toShow.length; i++) {
                ...
                s.style.display = this._changingLayout && this.animation.animateChangeLayout ? this._newDisplay : this.layout.display,
                a.css(e._in),
                this.animation.animateResizeTargets && (s.style.width = s.dataset.finalWidth + "px",
                s.style.height = s.dataset.finalHeight + "px",
                s.style.marginRight = -(s.dataset.finalWidth - s.dataset.interWidth) + 1 * s.dataset.finalMarginRight + "px",
                s.style.marginBottom = -(s.dataset.finalHeight - s.dataset.interHeight) + 1 * s.dataset.finalMarginBottom + "px")
            }
            for (i = 0; i < this._$pre.length; i++) {
                ...
                e = this._getPrefixedCSS("transform", "translate(" + n.x + "px," + n.y + "px)");
                a.css(e),
                this.animation.animateResizeTargets && (s.style.width = s.dataset.origWidth + "px",
                s.style.height = s.dataset.origHeight + "px",
                s.dataset.origWidth - s.dataset.finalWidth && (s.style.marginRight = -(s.dataset.origWidth - s.dataset.interWidth) + 1 * s.dataset.origMarginRight + "px"),
                s.dataset.origHeight - s.dataset.finalHeight && (s.style.marginBottom = -(s.dataset.origHeight - s.dataset.interHeight) + 1 * s.dataset.origMarginBottom + "px"))
            }
        ...
        _animateTargets: function() {
            ...
            for (var e = 0; e < this._$toShow.length; e++) {
                ...
                for (var o = 0; o < 2; o++) {
                    ...
                    this._ff && this._ff <= 20 && (r[l + "transition-property"] = "all",
                    r[l + "transition-timing-function"] = this.animation.easing + "ms",
                    r[l + "transition-duration"] = this.animation.duration + "ms"),
                    r[l + "transition-delay"] = n + "ms",
                    r[l + "transform"] = "translate(" + a.x + "px," + a.y + "px)"
                }
                (this.effects.transform || this.effects.opacity) && this._bindTargetDone(s),
                this._ff && this._ff <= 20 ? s.css(r) : s.css(this.effects.transition).css(r)
            }
            for (e = 0; e < this._$pre.length; e++) {
                ...
                n = this._getDelay(e);
                i.dataset.finalPosX === i.dataset.origPosX && i.dataset.finalPosY === i.dataset.origPosY || this._bindTargetDone(s),
                s.css(this._getPrefixedCSS("transition", "all " + this.animation.duration + "ms " + this.animation.easing + " " + n + "ms")),
                s.css(this._getPrefixedCSS("transform", "translate(" + a.x + "px," + a.y + "px)")),
                this.animation.animateResizeTargets && (i.dataset.origWidth - i.dataset.finalWidth && 1 * i.dataset.finalWidth && (i.style.width = i.dataset.finalWidth + "px",
            ...
            for (e = 0; e < this._$toHide.length; e++) {
                ...
                var c = {};
                for (o = 0; o < 2; o++) {
                    c[(l = 0 === o ? l = this._prefix : "") + "transition-delay"] = n + "ms",
        ...
        _bindTargetDone: function(e) {
            ...
            s.dataset.bound || (s.dataset.bound = !0,
            i._targetsBound++,
            e.on("webkitTransitionEnd.mixItUp transitionend.mixItUp", function(a) {
                (a.originalEvent.propertyName.indexOf("transform") > -1 || a.originalEvent.propertyName.indexOf("opacity") > -1) && t(a.originalEvent.target).is(i.selectors.target) && (e.off(".mixItUp"),
        ...
        _getDelay: function(t) {
            var e = "function" == typeof this.animation.staggerSequence ? this.animation.staggerSequence.call(this._domNode, t, this._state) : t
        ...
        _parseMultiMixArgs: function(t) {
            for (var e = {
                ...
                var s = t[i];
                null !== s && ("object" == typeof s || "string" == typeof s ? e.command = s : "boolean" == typeof s ? e.animate = s : "function" == typeof s && (e.callback = s))
            }
        ...
        _parseInsertArgs: function(e) {
            for (var i = {
                ...
                var a = e[s];
                "number" == typeof a ? i.index = a : "object" == typeof a && a instanceof t ? i.$object = a : "object" == typeof a && this._helpers._isElement(a) ? i.$object = t(a) : "object" == typeof a && null !== a ? i.multiMix = a : "boolean" != typeof a || a ? "function" == typeof a && (i.callback = a) : i.multiMix = !1
            }
        ...
        multiMix: function() {
            var t = this._parseMultiMixArgs(arguments);
            if (this._execAction("multiMix", 0, arguments),
            this._mixing)
                this.animation.queue && this._queue.length < this.animation.queueLimit ? (this._queue.push(arguments),
                this.controls.enable && !this._clicking && this._updateControls(t.command),
                this._execAction("multiMixQueue", 1, arguments)) : ("function" == typeof this.callbacks.onMixBusy && this.callbacks.onMixBusy.call(this._domNode, this._state, this),
                ...
                this._refresh(),
                i && (this._newSort = this._parseSort(i),
                this._newSortString = i,
                this._sorting = !0,
                this._sort()),
                s !== e && (s = "all" === s ? this.selectors.target : s,
                this._activeFilter = s),
                this._filter(),
                a && (this._newDisplay = "string" == typeof a ? a : a.display || this.layout.display,
                this._newClass = a.containerClass || "",
                this._newDisplay === this.layout.display && this._newClass === this.layout.containerClass || (this._changingLayout = !0,
                this._changingClass = this._newClass !== this.layout.containerClass,
                this._changingDisplay = this._newDisplay !== this.layout.display)),
                this._$targets.css(this._brake),
                this._goMix(t.animate ^ this.animation.enable ? t.animate : this.animation.enable),
        ...
        getOption: function(t) {
            return t ? this._execFilter("getOption", function(t, i) {
                for (var s = i.split("."), a = s.pop(), n = s.length, r = 1, o = s[0] || i; (t = t[o]) && r < n; )
                    o = s[r],
                    r++;
                if (t !== e)
                    return t[a] !== e ? t[a] : t
        ...
        destroy: function(e) {
            ...
            this._$body.add(t(this.selectors.sort)).add(t(this.selectors.filter)).off(".mixItUp");
            ...
            i[this.selectors.filter] && i[this.selectors.filter] > 1 ? i[this.selectors.filter]-- : 1 === i[this.selectors.filter] && delete i[this.selectors.filter],
            s[this.selectors.sort] && s[this.selectors.sort] > 1 ? s[this.selectors.sort]-- : 1 === s[this.selectors.sort] && delete s[this.selectors.sort],
        ...
        return i = this.each(function() {
            if (s && "string" == typeof s[0]) {
                ...
                !function(e, i) {
                    ...
                    s._instances[e.id] || (s._instances[e.id] = s,
                    s._init(e, i)),
        ...
        this.each(function() {
            for (var a = this, n = i.split(" "), r = 0; r < n.length; r++)
                for (var o = 0; o < 4; o++) {
                    ...
                    if (a.style[l] !== e && "unknown" != typeof a.style[l] && a.style[l].length > 0 && (a.style[l] = ""),
                    !s && 1 === o)
                        break
                }
            a.attributes && a.attributes.style && a.attributes.style !== e && "" === a.attributes.style.value && a.attributes.removeNamedItem("style")
        })
    }
}(jQuery);
